# Generated by Django 3.1.7 on 2021-05-24 13:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('neutral', models.IntegerField(default=False)),
                ('surprise', models.IntegerField(default=False)),
                ('sad', models.IntegerField(default=False)),
                ('happy', models.IntegerField(default=False)),
                ('fear', models.IntegerField(default=False)),
                ('disgust', models.IntegerField(default=False)),
                ('angry', models.IntegerField(default=False)),
